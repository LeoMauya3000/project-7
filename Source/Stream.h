...
//	 Pointer to a FILE (AKA Stream) if the file was opened successfully.
...
// Read a token (a single word) from a stream.
// Suggested steps:
...
// (NOTE: Do not attempt to close an unopened stream.)
// (PRO TIP: Avoid dangling pointers by setting the Stream to NULL.)
// Params:
