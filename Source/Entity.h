...
// (NOTE: It is possible for an Entity to contain all or none of the specified components.
//   Your code must perform sufficient error checking to ensure that Entities missing one
//   or more components are handled properly (i.e. no crashes, no unexpected side-effects).
// Params:
//	 entity = Pointer to the Entity.
